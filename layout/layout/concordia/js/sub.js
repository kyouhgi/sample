...
$(document).ready(function(){
	...
	var include = "layout/concordia/contents/temp" + val2 + ".html";
   ...
   //      },
   //      beforeSend: function(){	//(더 확인요2-1)컨텐츠 나오기 전에 나오는 이미지영역
   //      	$("#loading").show();
   //      },
   //      complete: function(){	//(더 확인요2-2)위에 것과 같이 확인 요.
   //      	$("#loading").hide();
   //      }
   //   });
   //});
	...
	var pageWidth      = 1000; 
	var leftOffet      = 250; 	
	var leftMargin     = 750;	  //화면이 작아져도 좌우로 움직없이 유지시켜줌.
	var speed          = 100;   
